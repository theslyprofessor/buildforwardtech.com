...
export const LABS_PROJECTS = [
  ...
  },
  {
    id: "convex-compose",
    name: "ConvexCompose",
    fullName: "Open-Source Modular ERP Framework",
    url: "https://convex.store",
    tagline: "Compose Convex apps from modules",
    description: "An open-source modular ERP framework built on Convex. Pre-built business modules — mail, tasks, inventory, LMS, booking — drop into any full-stack Convex application. Three-layer portability (Convex core + framework-agnostic React + thin route wrappers) means modules work in TanStack Start, Next.js, or Remix. The unbundled Odoo for the React/Convex era, extracted from battle-tested Midimaze code.",
    tag: "Open Source",
    status: "Beta — 2 modules live, 10 in roadmap",
